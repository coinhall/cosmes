...
// @generated from file dymensionxyz/dymension/incentives/gauge.proto (package dymensionxyz.dymension.incentives, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class Gauge extends Message<Gauge> {
  ...
  static readonly typeName = "dymensionxyz.dymension.incentives.Gauge";
...
export class LockableDurationsInfo extends Message<LockableDurationsInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dymensionxyz.dymension.incentives.LockableDurationsInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
