...
export class MsgCreateBalancerPool extends Message<MsgCreateBalancerPool> {
  ...
  /**
   * @generated from field: dymensionxyz.dymension.gamm.v1beta1.PoolParams pool_params = 2;
   */
  ...
  static readonly typeName = "dymensionxyz.dymension.gamm.poolmodels.balancer.v1beta1.MsgCreateBalancerPool";
...
export class MsgCreateBalancerPoolResponse extends Message<MsgCreateBalancerPoolResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "dymensionxyz.dymension.gamm.poolmodels.balancer.v1beta1.MsgCreateBalancerPoolResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
