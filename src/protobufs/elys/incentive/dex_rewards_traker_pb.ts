...
// @generated from file elys/incentive/dex_rewards_traker.proto (package elys.incentive, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message elys.incentive.DexRewardsTracker
 */
export class DexRewardsTracker extends Message<DexRewardsTracker> {
   ...
   *
   * @generated from field: string amount_collected_by_other_tracker = 3;
   */
  ...
  static readonly typeName = "elys.incentive.DexRewardsTracker";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "num_blocks", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "amount_collected_by_other_tracker", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
