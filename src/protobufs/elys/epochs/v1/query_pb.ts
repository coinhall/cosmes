 ...
 * method.
 *
 * @generated from message elys.epochs.v1.QueryEpochsInfoRequest
 */
export class QueryEpochsInfoRequest extends Message<QueryEpochsInfoRequest> {
  ...
  static readonly typeName = "elys.epochs.v1.QueryEpochsInfoRequest";
 ...
 * method.
 *
 * @generated from message elys.epochs.v1.QueryEpochsInfoResponse
 */
export class QueryEpochsInfoResponse extends Message<QueryEpochsInfoResponse> {
  /**
   * epochs is a slice of all EpochInfos
   *
   * @generated from field: repeated elys.epochs.v1.EpochInfo epochs = 1;
   */
  epochs: EpochInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "elys.epochs.v1.QueryEpochsInfoResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * method.
 *
 * @generated from message elys.epochs.v1.QueryCurrentEpochRequest
 */
export class QueryCurrentEpochRequest extends Message<QueryCurrentEpochRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "elys.epochs.v1.QueryCurrentEpochRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * method.
 *
 * @generated from message elys.epochs.v1.QueryCurrentEpochResponse
 */
export class QueryCurrentEpochResponse extends Message<QueryCurrentEpochResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "elys.epochs.v1.QueryCurrentEpochResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
