 ...
 *
 * @generated from message osmosis.concentratedliquidity.v1beta1.MsgCreateConcentratedPool
 */
export class MsgCreateConcentratedPool extends Message<MsgCreateConcentratedPool> {
  ...
  static readonly typeName = "osmosis.concentratedliquidity.v1beta1.MsgCreateConcentratedPool";
 ...
 *
 * @generated from message osmosis.concentratedliquidity.v1beta1.MsgCreateConcentratedPoolResponse
 */
export class MsgCreateConcentratedPoolResponse extends Message<MsgCreateConcentratedPoolResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "osmosis.concentratedliquidity.v1beta1.MsgCreateConcentratedPoolResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
