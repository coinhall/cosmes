...
// @generated from file osmosis/pool-incentives/v1beta1/incentives.proto (package osmosis.poolincentives.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message osmosis.poolincentives.v1beta1.PoolToGauges
 */
export class PoolToGauges extends Message<PoolToGauges> {
  /**
   * @generated from field: repeated osmosis.poolincentives.v1beta1.PoolToGauge pool_to_gauge = 2;
   */
  poolToGauge: PoolToGauge[] = [];

  constructor(data?: PartialMessage<PoolToGauges>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "osmosis.poolincentives.v1beta1.PoolToGauges";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "pool_to_gauge", kind: "message", T: PoolToGauge, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PoolToGauges {
    return new PoolToGauges().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PoolToGauges {
    return new PoolToGauges().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PoolToGauges {
    return new PoolToGauges().fromJsonString(jsonString, options);
  }

  static equals(a: PoolToGauges | PlainMessage<PoolToGauges> | undefined, b: PoolToGauges | PlainMessage<PoolToGauges> | undefined): boolean {
    return proto3.util.equals(PoolToGauges, a, b);
  }
}
