 ...
 * Since: x/authz 1.0.0
 *
 * @generated from message cosmos.authz.v1beta1.EventPruneExpiredGrants
 */
export class EventPruneExpiredGrants extends Message<EventPruneExpiredGrants> {
  /**
   * Address of the pruner
   *
   * @generated from field: string pruner = 2;
   */
  pruner = "";

  constructor(data?: PartialMessage<EventPruneExpiredGrants>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cosmos.authz.v1beta1.EventPruneExpiredGrants";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "pruner", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): EventPruneExpiredGrants {
    return new EventPruneExpiredGrants().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): EventPruneExpiredGrants {
    return new EventPruneExpiredGrants().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): EventPruneExpiredGrants {
    return new EventPruneExpiredGrants().fromJsonString(jsonString, options);
  }

  static equals(a: EventPruneExpiredGrants | PlainMessage<EventPruneExpiredGrants> | undefined, b: EventPruneExpiredGrants | PlainMessage<EventPruneExpiredGrants> | undefined): boolean {
    return proto3.util.equals(EventPruneExpiredGrants, a, b);
  }
}
